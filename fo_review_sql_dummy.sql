...
DROP DATABASE IF EXISTS `db_sahabat_unggul`;
...
DROP TABLE IF EXISTS `fo_review_d`;
...
REPLACE INTO `fo_review_d` (`rev_id`, `rev_proc_id`, `rev_ss`, `rev_rej`, `rev_seam`, `rev_spi`, `rev_dim`, `rev_oth`, `rev_act`, `rev_c_aes`, `rev_c_func`, `rev_c_dim`, `rev_c_stat`, `add_date`, `add_id`, `mod_date`, `mod_id`) VALUES
	(1, '3192', 0, 0, 'seam', 'spi', 'dim', 'oth', 'act', NULL, NULL, NULL, NULL, '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, '3193', 0, 0, 'seam', 'spi', 'dim', 'oth', 'act', NULL, NULL, NULL, NULL, '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, '3194', 0, 0, 'seam', 'spi', 'dim', 'oth', 'act', NULL, NULL, NULL, NULL, '2025-06-13 11:35:59', 161, NULL, NULL);

-- Dumping structure for table db_sahabat_unggul.fo_review_dc
DROP TABLE IF EXISTS `fo_review_dc`;
...
REPLACE INTO `fo_review_dc` (`rev_id`, `rev_proc_id`, `rev_proc`, `rev_mc`, `rev_seam`, `rev_spi`, `rev_dim`, `rev_oth`, `rev_act`, `rev_c_aes`, `rev_c_func`, `rev_c_dim`, `rev_c_stat`, `add_date`, `add_id`, `mod_date`, `mod_id`) VALUES
	(1, 'DC1', '', NULL, NULL, NULL, NULL, NULL, NULL, 'aes', 'func', 'c_dim', 'stat', '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, 'DC2', '', NULL, NULL, NULL, NULL, NULL, NULL, 'aes', 'func', 'c_dim', 'stat', '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, 'DC3', '', NULL, NULL, NULL, NULL, NULL, NULL, 'aes', 'func', 'c_dim', 'stat', '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, 'DC4', '', NULL, NULL, NULL, NULL, NULL, NULL, 'aes', 'func', 'c_dim', 'stat', '2025-06-13 11:35:59', 161, NULL, NULL),
	(1, 'DC5', '', NULL, NULL, NULL, NULL, NULL, NULL, 'aes', 'func', 'c_dim', 'stat', '2025-06-13 11:35:59', 161, NULL, NULL);

-- Dumping structure for table db_sahabat_unggul.fo_review_h
DROP TABLE IF EXISTS `fo_review_h`;
...
REPLACE INTO `fo_review_h` (`rev_id`, `rev_date`, `rev_line`, `rev_group`, `rev_part`, `rev_by`, `rev_stage`, `rev_ss`, `rev_rej`, `add_date`, `add_id`, `mod_date`, `mod_id`) VALUES
	(1, '2025-06-13', '08', 'A', '11027-78339', 'Bimo', 'PP', NULL, NULL, '2025-06-13 11:35:59', 161, NULL, NULL);
